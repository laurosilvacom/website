				...
				<div className="mx-auto max-w-6xl text-center">
					<div className="animate-in fade-in slide-in-from-bottom-4 space-y-12 duration-1000">
						...
						<p className="text-muted-foreground mx-auto max-w-2xl text-xl leading-relaxed sm:text-2xl">
							Technical leadership, hands-on development, and team training to help you
							make better decisions, ship faster, and build products that work.
						</p>
					</div>
				...
				<Container width="base">
					<div className="space-y-8">
						...
						<div className="text-muted-foreground space-y-6 text-lg leading-relaxed">
							<p>
								Great products come from understanding both the technology and the people
								who use it. The best engineering teams aren&apos;t just technically
								skilled — they understand how to build software that solves real problems.
							</p>
							<p>
								My approach is practical and hands-on. I&apos;ve worked with teams at
								Google, O&apos;Reilly, Sentry, and HOKA building products that scale. I
								bring that experience to help your team make better decisions, ship
								faster, and build products that actually matter.
							</p>
							<p>
								Technology should serve people. The work should be intentional. The teams
								should be strong. That&apos;s what I focus on.
							</p>
						</div>
					</div>
				</Container>
						...
						<div className="grid gap-8 md:grid-cols-2">
							<div className="border-border bg-card space-y-4 rounded-2xl border p-8">
								...
								<p className="text-muted-foreground leading-relaxed">
									Your team needs a senior full-stack engineer who can hit the ground
									running. I embed with your team, understand your codebase, and start
									shipping from week one.
								</p>
							</div>

							<div className="border-border bg-card space-y-4 rounded-2xl border p-8">
								<h3 className="text-xl font-semibold">You need technical leadership</h3>
								<p className="text-muted-foreground leading-relaxed">
									You need someone to help guide technical decisions, improve your
									architecture, or provide hands-on development for complex problems.
								</p>
							</div>

							<div className="border-border bg-card space-y-4 rounded-2xl border p-8">
								<h3 className="text-xl font-semibold">You want to level up your team</h3>
								<p className="text-muted-foreground leading-relaxed">
									Your team needs training on modern tools like React, Next.js,
									TypeScript, or AI integration. You want learning that sticks, not just
									information dumps.
								</p>
							</div>

							<div className="border-border bg-card space-y-4 rounded-2xl border p-8">
								<h3 className="text-xl font-semibold">You value practical expertise</h3>
								<p className="text-muted-foreground leading-relaxed">
									You want someone who&apos;s built products at scale, worked with large
									teams, and understands how to ship software that actually works.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="space-y-12">
						...
						<div className="border-border bg-primary/5 rounded-2xl border p-8">
							<div className="space-y-4">
								...
								<p className="text-muted-foreground leading-relaxed">
									I bring enterprise-level expertise from Google, O&apos;Reilly, Sentry,
									and HOKA to help your team build better products. I understand both the
									technical challenges of building at scale and the urgency of shipping
									fast.
								</p>
							</div>
						</div>
						...
						<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
							<blockquote className="border-border bg-card space-y-6 rounded-2xl border p-8">
								...
								<p className="text-foreground text-base leading-relaxed lg:text-lg">
									Lauro is a total pro. His guidance helped us create polished onboarding
									videos and build the capability to create content independently.
								</p>
							...
							<blockquote className="border-border bg-card space-y-6 rounded-2xl border p-8">
								...
								<p className="text-foreground text-base leading-relaxed lg:text-lg">
									An hour with Lauro helped me untangle my thoughts and make a concrete
									plan. If you need dev content strategy, he&apos;s your person.
								</p>
								<div className="border-border flex items-center gap-3 border-t pt-6">
									<div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-full">
										<Image
							...
							<blockquote className="border-border bg-card space-y-6 rounded-2xl border p-8">
								...
								<p className="text-foreground text-base leading-relaxed lg:text-lg">
									Working with Lauro is always a great experience. His technical guidance
									and patience make complex projects feel manageable.
								</p>
								<div className="border-border flex items-center gap-3 border-t pt-6">
									<div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-full">
										<Image
					...
					<div className="border-border bg-card space-y-8 rounded-3xl border p-12 text-center lg:p-16">
						<div className="space-y-6">
							...
							<p className="text-muted-foreground mx-auto max-w-2xl text-lg leading-relaxed lg:text-xl">
								Let&apos;s discuss how I can help your team build better products and
								develop stronger engineering capabilities.
							</p>
						</div>
						<div className="pt-4">
							<Button asChild size="lg" className="group">
