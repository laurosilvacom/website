					...
					<div className="mx-auto grid max-w-5xl gap-12 md:grid-cols-3">
						<div className="space-y-4">
							...
							<p className="text-muted-foreground text-base leading-relaxed">
								Every time I publish something new, you'll be the first to know. No
								algorithms, no feeds - just direct delivery of new content.
							</p>
						</div>

						<div className="space-y-4">
							<h3 className="text-foreground text-xl font-bold">Exclusive insights</h3>
							<p className="text-muted-foreground text-base leading-relaxed">
								Occasional thoughts, lessons, and discoveries that don't make it to the
								blog but are worth sharing with the community.
							</p>
						</div>

						<div className="space-y-4">
							<h3 className="text-foreground text-xl font-bold">No spam, ever</h3>
							<p className="text-muted-foreground text-base leading-relaxed">
								I only email when I have something worth sharing. Your inbox is sacred,
								and I respect that. Unsubscribe anytime with one click.
							</p>
						</div>
					</div>
				</Container>
