				...
				<section className="py-24 lg:py-32">
					<Container width="base">
						<div className="mx-auto max-w-3xl">
							<p className="text-foreground font-serif text-xl leading-relaxed lg:text-2xl">
								The same curiosity that drives me to understand how systems work in code
								also pushes me to understand how communities form and grow. The discipline
								I learn on long trail runs translates directly to how I approach building
								products.
							</p>
						</div>
					</Container>
					...
					<Container width="base">
						<div className="mx-auto max-w-3xl space-y-12">
							...
							<div className="text-muted-foreground space-y-6 text-base leading-relaxed">
								<p>
									Technology should serve people, not the other way around. The best
									software I've built has always started with understanding the humans who
									will use it - their needs, their constraints, their aspirations.
								</p>
								<p>
									I believe in building things that matter. That means working with
									organizations and people who are trying to make the outdoor industry
									more accessible, more inclusive, and more connected. It means writing
									code that solves real problems, not just technical ones.
								</p>
								<p>
									And I believe that the best work happens when you bring your whole self
									to it. My identity as a runner of color, as someone who has built
									community from the ground up, and as a technologist - these aren't
									separate things. They're all part of how I see the world and how I
									build.
								</p>
							</div>
						</div>
				...
				<section className="py-24 lg:py-32">
					<Container width="base">
						<div className="bg-card border-border-subtle mx-auto max-w-3xl space-y-8 rounded-3xl border p-12 text-center lg:p-16">
							<div className="space-y-6">
								<p className="text-foreground font-serif text-xl leading-relaxed font-semibold lg:text-2xl">
								...
								<p className="text-muted-foreground text-base leading-relaxed lg:text-lg">
									They're all part of how I approach the world and how I do my work. They
									inform each other, challenge each other, and make me better at all of
									them.
								</p>
							</div>
							<div className="pt-4">
